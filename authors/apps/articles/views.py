...
from rest_framework.generics import RetrieveUpdateAPIView, ListCreateAPIView, DestroyAPIView, UpdateAPIView
...
from .serializers import ArticleSerializer, ArticleAuthorSerializer, CommentSerializer, ReplySerializer
